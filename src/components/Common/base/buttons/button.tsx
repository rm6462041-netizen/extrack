...
export const styles = sortCx({
    ...
    colors: {
        ...
        secondary: {
            root: [
                "bg-[var(--bg-card)] text-secondary shadow-xs-skeuomorphic ring-1 ring-primary ring-inset hover:bg-primary_hover hover:text-secondary_hover data-loading:bg-primary_hover",
                // Icon styles
